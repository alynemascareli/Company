...
{
    public class CompanyParamsControllerDelete
    {
        readonly CompanyParamsController _controller;

        public CompanyParamsControllerDelete()
        {
        ...
        public void Remove_NotExistingIdPassed_ReturnsNotFoundResponse()
        {
            ...
            // Act
            var badResponse = _controller.DeleteCompanyParams(notExistingId);
        ...
        public void Remove_ExistingIdPassed_ReturnsOkResult()
        {
            ...
            // Act
            var okResponse = _controller.DeleteCompanyParams(existingId);
        ...
        public void Remove_ExistingIdPassed_RemovesOneItem()
        {
            ...
            // Assert
            var okResult = _controller.GetCompanyParams(existingId).Result as OkObjectResult;
            var items = Assert.IsType<List<CompanyParams>>(okResult.Value);
